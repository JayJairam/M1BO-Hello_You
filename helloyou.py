...
def caves():
    ...
    print("wat ga je doen, ga je voor de daimonds of monster")
    ...
    for i in range(5):
        ...
        if choice == 'daimonds':
            ...
            time.sleep(2.8)
            print("pak je het hoofd van de moster of pak je de daimonds")
        else:
            print("kiez uit hoofd van moster of daimonds")
